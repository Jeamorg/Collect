...
sudo nohup proxychains ./lite-linux-amd64 --config ./lite_config.json --test https://raw.githubusercontent.com/Jeamorg/Collect/master/sub/airport_merge_yaml.yml > speedtest.log 2>&1 &
