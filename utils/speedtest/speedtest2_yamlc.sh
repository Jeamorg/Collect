...
wget -O lite_config.json https://c.jeam.cc/utils/speedtest/lite_config_yaml.json
#初始化 Clash
chmod +x ./clash && ./clash &
#安装并配置 proxychains
...
sudo nohup proxychains ./lite-linux-amd64 --config ./lite_config.json --test https://c.jeam.cc/sub/sub_merge_yaml.yml > speedtest.log 2>&1 &
